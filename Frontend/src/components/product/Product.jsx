...
//  console.log(notFound)
  ...
  return (
    <>
      <Box sx={{ padding: 2 }} >
        <Grid2 container spacing={2} columns={30} sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }} >
          {allProductData.length > 0 &&
            allProductData.map((item, index) => {
              return <Grid2 size={{ xs: 30, sm: 15, md: 10, lg: 6 }} key={index}  >
                 ...
                 <div style={{width: '100%', height: '220px',overflow:'hidden', borderRadius: '20px',marginBottom:'20px' }} > 
                    ...
                    <div className='productInfo' >
                      ...
                      <div className='rating' >
                        <Rating style={{marginTop:'10px'}} name="half-rating-read" value={item?.rating || 0} precision={0.5}  />
